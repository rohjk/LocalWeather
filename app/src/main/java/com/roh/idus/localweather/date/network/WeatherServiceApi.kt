...
interface WeatherServiceApi {
    ...
    @GET("location/search")
    fun getLocations(@Query("query") search: String): Observable<Response<List<LocationRemote>>>

    @GET("location/{id}")
    fun getWeather(@Path("id") id: Long): Observable<Response<WeatherInfoRemote>>
}